...
# 附录 IV：SDLC 工具栈分层深度研究（子目录）

附录 III 给出 SDLC 栈 22 层的 Pre/Post-Agent 对比框架，每层只能一行。本附录把"每一层用 subagent 并行做深度研究"的成果拆到独立子目录 [`chat/SDLC-stack/`](SDLC-stack/)：

- 索引文件：[`chat/SDLC-stack/00-index.md`](SDLC-stack/00-index.md) — 12 篇报告一句话本质 + 6 条跨层主线
- 12 篇分层深度报告（合计 ~4 万字、240+ IEEE 引用，全部用 2025–2026 一手数据）：

| 层 | 报告 | 关键代表公司 |
|---|---|---|
| L01 规划 / 工单 | [`01-planning-tickets.md`](SDLC-stack/01-planning-tickets.md) | Linear、Atlassian Jira |
| L02 设计 + Vibe coding | [`02-design-vibe-coding.md`](SDLC-stack/02-design-vibe-coding.md) | Lovable、Bolt.new、v0、Replit Agent |
| L03 知识 / 答疑 | [`03-knowledge-qa.md`](SDLC-stack/03-knowledge-qa.md) | Stack Overflow（衰败）、Context7 |
| L04 IDE + AI 编辑器 | [`04-ide-ai-editor.md`](SDLC-stack/04-ide-ai-editor.md) | Cursor、Copilot、Windsurf、Zed |
| L05 终端 / 自治 Coding Agent | [`05-coding-agent-cli.md`](SDLC-stack/05-coding-agent-cli.md) | Claude Code、Devin、Codex CLI |
| L06 版本控制 + AI 评审 | [`06-vcs-review.md`](SDLC-stack/06-vcs-review.md) | CodeRabbit、Greptile、GitHub、GitLab |
| L07 CI/CD + 构建 | [`07-ci-build.md`](SDLC-stack/07-ci-build.md) | namespace.so、Depot、Blacksmith |
| L08 测试 Agent | [`08-test-agents.md`](SDLC-stack/08-test-agents.md) | Meticulous、Qodo、Diffblue |
| L09 安全 / 漏洞 | [`09-security-vuln.md`](SDLC-stack/09-security-vuln.md) | Socket、Snyk、Semgrep、Endor Labs |
| L10 代码索引 + Dev MCP | [`10-code-index-mcp.md`](SDLC-stack/10-code-index-mcp.md) | Sourcegraph、Augment、MCP gateway |
| L11 可观测 + 事故响应 | [`11-observability-incident.md`](SDLC-stack/11-observability-incident.md) | Datadog Bits AI、Sentry Seer、Resolve.ai |
| L12 文档 + IDP | [`12-docs-idp.md`](SDLC-stack/12-docs-idp.md) | Mintlify、Backstage、Cortex |

每篇都按 namespace.so 范式作答：(1) Pre-Agent 流量模式 → (2) Agent 时代如何突变 → (3) 新需求 → (4) 代表公司如何解决（含技术架构、配置示例） → (5) 几条本质判断。具体数据 / 代码 / 配置示例都在子文件里。
