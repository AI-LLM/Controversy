...
要害在于分清两个一直被混为一谈的"边际成本"：**复制"工人"的边际成本 ≈ 0（软件性质，这是"劳动力突然激增"的来源），执行一份"工作"的边际成本为正（劳动力性质，这是它"是劳动力、不是工具"的来源）**。传统软件两者都接近零，人类两者都不接近零，LLM 恰好一边各取一半。正是这"免费复制的工人 + 计件付费的活"的组合，让它在成本量级上贴近人类知识工作者、与传统软件根本不同。
