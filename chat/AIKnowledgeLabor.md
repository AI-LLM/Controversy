...
- [一、历史镜鉴：三次"劳动力突然激增"如何重写社会](#一历史镜鉴三次劳动力突然激增如何重写社会)
  ...
  - [1.4 共同规律](#14-共同规律)
- [二、LLM 的能力轮廓：为什么它是"劳动力"，而不是工具](#二llm-的能力轮廓为什么它是劳动力而不是工具)
  ...
  - [2.8 推论：纯 LLM 不可能达到比特级确定性](#28-推论纯-llm-不可能达到比特级确定性)
  - [2.9 错误率可以被数学控制吗](#29-错误率可以被数学控制吗)
    - [2.9.1 PAC 学习理论：可可能近似正确](#291-pac-学习理论可可能近似正确)
    - [2.9.2 标度律：错误率与算力/参数量的幂律](#292-标度律错误率与算力参数量的幂律)
    - [2.9.3 置信度校准：让"模型说自己 90% 有把握"真的意味着 90%](#293-置信度校准让模型说自己-90-有把握真的意味着-90)
    - [2.9.4 多次采样 + 验证器：错误率指数级衰减](#294-多次采样-验证器错误率指数级衰减)
  - [2.10 纠错的计算量非对称性：必须靠"传统骨骼"重建](#210-纠错的计算量非对称性必须靠传统骨骼重建)
    - [2.10.1 传统计算机的天然优势：纠错远比求解便宜](#2101-传统计算机的天然优势纠错远比求解便宜)
    - [2.10.2 LLM 原生世界的窘境：纠错 ≈ 重新求解](#2102-llm-原生世界的窘境纠错-重新求解)
    - [2.10.3 当前工业界如何"恢复"非对称性](#2103-当前工业界如何恢复非对称性)
  - [2.11 IT 产业的反向印证：传统计算机正在成为 AI 的"骨骼"](#211-it-产业的反向印证传统计算机正在成为-ai-的骨骼)
    - [2.11.1 服务器 CPU：作为"宿主控制核心"的需求暴增](#2111-服务器-cpu作为宿主控制核心的需求暴增)
    - [2.11.2 Hyperscaler 资本开支：四家 2025 年合计 3,000–3,800 亿美元](#2112-hyperscaler-资本开支四家-2025-年合计-3000-3800-亿美元)
    - [2.11.3 边缘 AI 与端侧大模型：传统 PC 组件被迫"内卷升级"](#2113-边缘-ai-与端侧大模型传统-pc-组件被迫内卷升级)
    - [2.11.4 存储芯片短缺：AI 算力胃口挤压消费电子供应](#2114-存储芯片短缺ai-算力胃口挤压消费电子供应)
