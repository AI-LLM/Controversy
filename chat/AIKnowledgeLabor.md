...
| Harness 元素 | 传统工种（Human)→现代LLM+Harness(AI Knowledge Labor) | 过去能配齐的组织 |
|---|---|---|
...
目前每一个试图使用AI的软件企业都在自行摸索，但预计会有专门研究软件工程的团队和供应商用管理学和工程学的方法论和工具来实现对应特定工种的，通用于多种应用领域的LLM+Harness方案。软件企业的工作未来会集中到更垂直的细分领域。
...
graph TD
    ...
    subgraph SP [能否运用AI？]
        ...
        A2 ==> Q1{足够满足?}
        Q1 == 否 ==> A3[评估 LLM + 通用/垂直 Harness 方案<br/>参考 §3.2.1.6]
        A3 ==> Q2{足够满足?}
    end
    Q1 == 是 ==> U[直接使用]
    Q2 == 是 ==> U
