...
主文件 `chat/美股软件股近期重挫 (2026-05-13).md` 附录 III 的 C 表是本目录的索引母表，本目录是 C 表的展开。两份文件互为正反——主文件是"市场 / 股价 / 估值"视角，本目录是"工具栈 / 技术架构"视角。同一组现象（SaaSpocalypse、AI Agent 重组、卖席位的输 / 卖铲子的赢）从两边互相验证。
